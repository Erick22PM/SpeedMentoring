        ...
        <div className="container-fluid">
          <ul className="nav nav-underline">
            <li className="nav-item">
              <a className="nav-link" style={{ color: '#3A2E01', fontWeight: 'bold' }} href="/SP_Student">Agenda</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" style={{ color: '#3A2E01', fontWeight: 'bold' }} href="/SP_Student/sesiones">Sesiones</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" style={{ color: '#3A2E01', fontWeight: 'bold' }} href="/SP_Student/eventos">Eventos</a>
            </li>
          </ul>
          <ul className="nav justify-content-end">
            ...
            <li className="nav-item">
              <a className="navbar-brand" href="/SP_Student/perfil">
